...
[https://aesopstoryengine.com/blog/](https://aesopstoryengine.com/blog/)

New Map Styles: New Feature

[https://aesopstoryengine.com/updates/new-feature-map-style/](https://aesopstoryengine.com/updates/new-feature-map-style/)

Horizontal Gallery: New Feature
...
Panorama Mode: New feature  v 1.9.10   
...
= 2.3.2 =
* Restoring ai_story_collection

= 2.3.1 =
* Collection Block fix

= 2.3.0 =
* Document component Microsoft fix
* Gutenberg JS update

= 2.2.10 =
* Twenty Twenty One compatibility fix

= 2.2.8 =
* Fix for browser class code

= 2.2.7 =
* Fixed a compatibility issue with old theme versions

= 2.2.6 =
* Fixed an issue with Classic Editor

= 2.2.5 =
* Lightbox has been updated with Lokesh Dakar's Lightbox2 codes
  https://lokeshdhakar.com/projects/lightbox2/#license

= 2.2.4 =
* Grid and Photoset Gallery Lightbox option fix
...
= 2.0.8 =
* FIX Fixes for gallery and video
...
= 2.0.4 =
* NEW Mute option for Video. Youtube/Vimeo videos need to be muted to be autoplayed
...
= 1.9.10.1 =
* FIX fixed some bugs with Panorama
